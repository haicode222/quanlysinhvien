...
namespace quanlysinhvien {
    ...
    public partial class DbQLSVDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK_SinhVien_LopQL;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK_SinhVien_LopQL = this.Relations["FK_SinhVien_LopQL"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK_SinhVien_LopQL = new global::System.Data.DataRelation("FK_SinhVien_LopQL", new global::System.Data.DataColumn[] {
                        this.tableLopQL.MaLopColumn}, new global::System.Data.DataColumn[] {
                        this.tableSinhVien.MaLopColumn}, false);
            this.Relations.Add(this.relationFK_SinhVien_LopQL);
        }
        ...
        public partial class LopQLDataTable : global::System.Data.TypedTableBase<LopQLRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public LopQLRow AddLopQLRow(string MaLop, string TenLop) {
        ...
        public partial class SinhVienDataTable : global::System.Data.TypedTableBase<SinhVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public SinhVienRow AddSinhVienRow(int MaSV, string HoTen, LopQLRow parentLopQLRowByFK_SinhVien_LopQL) {
                SinhVienRow rowSinhVienRow = ((SinhVienRow)(this.NewRow()));
                object[] columnValuesArray = new object[] {
                        MaSV,
                        HoTen,
                        null};
                if ((parentLopQLRowByFK_SinhVien_LopQL != null)) {
                    columnValuesArray[2] = parentLopQLRowByFK_SinhVien_LopQL[0];
                }
        ...
        public partial class LopQLRow : global::System.Data.DataRow {
            ...
            public SinhVienRow[] GetSinhVienRows() {
                if ((this.Table.ChildRelations["FK_SinhVien_LopQL"] == null)) {
                    return new SinhVienRow[0];
                }
                else {
                    return ((SinhVienRow[])(base.GetChildRows(this.Table.ChildRelations["FK_SinhVien_LopQL"])));
                }
            }
        }
        ...
        public partial class SinhVienRow : global::System.Data.DataRow {
            ...
            public LopQLRow LopQLRow {
                get {
                    return ((LopQLRow)(this.GetParentRow(this.Table.ParentRelations["FK_SinhVien_LopQL"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_SinhVien_LopQL"]);
                }
            }
...
namespace quanlysinhvien.DbQLSVDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::quanlysinhvien.Properties.Settings.Default.DbQLSVConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT COUNT(*) FROM Users WHERE Username = @user AND Password = @pass";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@user", global::System.Data.SqlDbType.NChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Username", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@pass", global::System.Data.SqlDbType.NChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Password", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DbQLSVDataSet.UsersDataTable dataTable) {
        ...
        public virtual DbQLSVDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DbQLSVDataSet.UsersDataTable dataTable = new DbQLSVDataSet.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DbQLSVDataSet.UsersDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> CheckLogin(string user, string pass) {
    ...
    public partial class LopQLTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[LopQL] WHERE (([MaLop] = @Original_MaLop) AND ([TenLop] = @Ori" +
                "ginal_TenLop))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[LopQL] ([MaLop], [TenLop]) VALUES (@MaLop, @TenLop);\r\nSELECT M" +
                "aLop, TenLop FROM LopQL WHERE (MaLop = @MaLop)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[LopQL] SET [MaLop] = @MaLop, [TenLop] = @TenLop WHERE (([MaLop] = @" +
                "Original_MaLop) AND ([TenLop] = @Original_TenLop));\r\nSELECT MaLop, TenLop FROM L" +
                "opQL WHERE (MaLop = @MaLop)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT MaLop, TenLop FROM dbo.LopQL";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(DbQLSVDataSet.LopQLDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual DbQLSVDataSet.LopQLDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DbQLSVDataSet.LopQLDataTable dataTable = new DbQLSVDataSet.LopQLDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DbQLSVDataSet.LopQLDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
...
SELECT MaSV, HoTen, MaLop FROM SinhVien WHERE (MaSV = @MaSV)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_MaSV, string Original_HoTen, string Original_MaLop) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int MaSV, string HoTen, string MaLop) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int MaSV, string HoTen, string MaLop, int Original_MaSV, string Original_HoTen, string Original_MaLop) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HoTen, string MaLop, int Original_MaSV, string Original_HoTen, string Original_MaLop) {
